...
INSERT INTO `groupprojectdb`.`categories` (`category`) VALUES ('Novel');
...
INSERT INTO `groupprojectdb`.`publishers` (`brand`, `info`) VALUES ('AGRA', 'info about AGRA');
...
INSERT INTO `groupprojectdb`.`authors` (`first_name`, `last_name`, `date_of_birth`, `biography`, `url_path`) VALUES ('Irvin D.', 'Yalom', '1931-06-13', 'Dr Irvin Yalom is Professor Emeritus of Psychiatry at Stanford University. He has won two major awards from the American Psychiatric Association. He continues to run his clinical practice and lectures widely.', 'Yalom.jpg');
...
INSERT INTO `groupprojectdb`.`books` (`title`, `summary`, `isbn`, `cover`, `special`, `year_published`, `price`, `url_path`, `publisher_id`,`quantity`) VALUES ('Weaveworld', 'Reissue of the highly acclaimed thriller by the world’s most outstanding dark fantasist. WEAVEWORLD is an epic adventure of the imagination. It begins with a carpet in which a world of rapture and enchantment is hiding; a world which comes to life, alerting the dark forces and beginning a desperate battle to preserve the last vestiges of magic which Humankind still has access to. WEAVEWORLD is a book of visions and horrors, a story of quest, titanic struggles, of love and of hope. It is a triumph of imagination and storytelling, an adventure, a nightmare, a promise… ‘Barker’s fecundity of invention is beyond praise. In a world of hard-bitten horror and originality, Clive Barker dislocates your mind.’ THE MAIL ON SUNDAY.', '978-960-620-453-1', 'Paperback', 'Best Seller', '2009', '18', 'weaveworld.jpg', '3','46');
INSERT INTO `groupprojectdb`.`books` (`title`, `summary`, `isbn`, `cover`, `special`, `year_published`, `book_series`, `price`, `url_path`, `publisher_id`,`quantity`) VALUES ('Hyperion', 'It is the 29th century and the universe of the Human Hegemony is under threat. Invasion by the warlike Ousters looms, and the mysterious schemes of the secessionist AI TechnoCore bring chaos ever closer. On the eve of disaster, with the entire galaxy at war, seven pilgrims set fourth on a final voyage to the legendary Time Tombs on Hyperion, home to the Shrike, a lethal creature, part god and part killing machine, whose powers transcend the limits of time and space. The pilgrims have resolved to die before discovering anyhting less than the secrets of the universe itself.', '9780575076372', 'Paperback', 'Best Seller', '2005', 'Hyperion Cantos', '14', 'hyperion.jpg', '2','13');
INSERT INTO `groupprojectdb`.`books` (`title`, `summary`, `isbn`, `cover`, `special`, `year_published`, `book_series`, `price`, `url_path`, `publisher_id`,`quantity`) VALUES ('The Fall of Hyperion', 'The mysterious Time Tombs are opening and the Shrike that has risen from them may well control the fate of all mankind. The Ousters are laying seige to the Hegemony of Man and the AIs we created have turned against us to build the Ultimate Intelligence; God. The God of Machines. His genesis could mean annihilation for man. Something is drawing the hegemony, the Ousters, the AIs, the entire universe to the Shrike.', '9780575099487', 'Paperback', 'Hot', '2012', 'Hyperion Cantos', '15', 'hyperionfall.jpg', '2','19');
INSERT INTO `groupprojectdb`.`books` (`title`, `summary`, `isbn`, `cover`, `year_published`, `price`, `url_path`, `publisher_id`,`quantity`) VALUES ('The Schopenhauer Cure', 'Suddenly confronted with his own mortality after a routine checkup, eminent psychotherapist Julius Hertzfeld is forced to reexamine his life and work -- and seeks out Philip Slate, a sex addict whom he failed to help some twenty years earlier. Yet Philip claims to be cured -- miraculously transformed by the pessimistic teachings of German philosopher Arthur Schopenhauer -- and is, himself, a philosophical counselor in training. Philip s dour, misanthropic stance compels Julius to invite Philip to join his intensive therapy group in exchange for tutoring on Schopenhauer. But with mere months left, life may be far too short to help Philip or to compete with him for the hearts and minds of the group members. And then again, it might be just long enough.', '9789603255840', 'Paperback', '2005', '18', 'schopenhauercure.jpg', '4','13');
...
INSERT INTO `groupprojectdb`.`written_by` (`book_id`, `author_id`) VALUES ('7', '4');
...
INSERT INTO `groupprojectdb`.`belongs` (`book_id`, `category_id`) VALUES ('7', '5');
