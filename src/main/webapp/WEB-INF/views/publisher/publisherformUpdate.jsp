                ...
                <div class="uk-width-4-5 uk-width-expand@s admin">
                    ...
                    <div id="main" class="uk-section">
                        <div  class="uk-container">
                            <h3 class="uk-card-title na">Publishers</h3>

                            <div class="uk-card uk-card-default uk-card-body">
                                <form:form method="POST" action="/GroupProject/publishers/formUpdatePublisher" modelAttribute="publisher" class="uk-form-horizontal uk-margin" >
                                    <div class="uk-margin">
                                    ...
                                    <div class="uk-margin">
                                        ...
                                        <div class="uk-form-controls">
                                            <form:input type="text" path="brand" id="brand" required="required" class="uk-input"/>
                                            <div class="has-error">
                                    ...
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-horizontal-text">Information</label>
                                        <div class="uk-form-controls">
                                            <form:input type="text" path="info" id="info" class="uk-input" />
                                            <div class="has-error">
                                    ...
                                    <div class="uk-margin">
                                        ...
                                        <div class="uk-form-controls">
                                            <c:choose>
                                                <c:when test="${edit}">
                                                    <input type="submit" value="Update" class="uk-button uk-button-secondary"/> or <a href="<c:url value='/publishers/' />">Cancel</a>
                                                </c:when>
                                                <c:otherwise>
                                                    <input type="submit" value="Save" class="uk-button uk-button-secondary"/> or <a href="<c:url value='/publishers/' />">Cancel</a>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </div>
