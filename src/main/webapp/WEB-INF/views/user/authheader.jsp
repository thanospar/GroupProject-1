    ...
    <ul class="uk-nav-default uk-nav-parent-icon uk-padding-small" uk-nav>
        ...
        <li class="uk-parent"><a href="#"><span class="uk-margin-small-right" uk-icon="icon:  tag"></span> Products </a>
            ...
            <ul class="uk-nav-sub">
                ...
                <li class="uk-nav-sub"><a href="<c:url value='/books/' />"><span class="uk-margin-small-right" uk-icon="icon: grid"></span> Books </a>


                </li>
                
                <li class="uk-nav-sub"><a href="<c:url value='/categories/' />"><span class="uk-margin-small-right" uk-icon="icon: grid"></span> Categories </a>
